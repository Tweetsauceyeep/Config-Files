...
call <sid>hi('markdownHeadingDelimiter',   s:gruberGold, '',          '',          '')
...
"Fixing Function shit
syn match Braces display '[{}()\[\]]'
call <sid>hi('Braces',    s:gruberFG, '', '', '')
