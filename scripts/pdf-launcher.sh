...
open -a XQuartz
find ~/Desktop ~/school  ~/school/Reaction_Images ~/school/Finished_Skoolworks -maxdepth 1 -type f \( -name "*.png" -o -name "*.pdf" -o -name "*.jpeg" -o -name "*.docx"  \) | dmenu -i -l '20' -p 'files' | xargs -I {} open "{}"
