...
/Applications/Alacritty.app/Contents/MacOS/alacritty  -t "${TITLE}" -o window.opacity=0.95 -o window.dimensions.lines=8 -o window.dimensions.columns=70 -o window.padding.y=5 -o window.padding.x=5 -e "$1"
